...
$private:Name = "pwsh-start-process"
$private:RequiredVersion = "0.0.2"
$private:Prelease = $true
$private:Repository = "agamemnon"

Initialize-Module -Name $Name -RequiredVersion $RequiredVersion -Prerelease $Prelease -Repository $Repository